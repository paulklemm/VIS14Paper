...
%
One is an specialist in internal medicine and also the head of the SHIP, the other an radiologist and responsible for the MRI-data acquisition of the entire SHIP. %and has a deep understanding on the available image data.
%
