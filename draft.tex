...
% \begin{itemize}
% 	\item [?] Was sind die requirements des tools?
% 	\item [?] how it was decided to create this particular design
% 	\item which kind of User interaction was made?
% 	\item Spezielle Anforderungen durch Webseitenformat, weggehen von allgemeinen UI Elementen wie Menubar, keine Rechtsklickmenüs.
% 	\item Entschieden eine saubere UI zu bauen, Unterscheide durch Whitespace akzentuieren. Interface in Fig. 3 zu sehen.
% 	\item Wie wird interagiert, wie wird gebrusht, was wird gelinkt?
% 	\item wie wird das Clustering initialisiert?
% 	\item auf Kontingenzmatrix mit verweisen als Teil des Interfaces (dieses auch noch anpassen)
% \end{itemize}
Early it became that we have to rely a lot on online communication with our clinical partners due to their busy schedule and our large spatial distance towards each other.
%
...
%\com{Contingency Matrix excellent for Overview}
\paragraph{Initialization and Interaction}
...
%
One is a specialist in internal medicine and also the head of the SHIP, the second a radiologist and responsible for the MRI data acquisition of the study. \com{Years of experience} %and has a deep understanding on the available image data.
%
