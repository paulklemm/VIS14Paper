...
%
Due to the short paper length, detail is missing on the data types and their algorithms of identifying similar subjects' works or whether they employ statistical measures.
%
...
Figure~\ref{fig:application}~(d) shows the results of the automatically triggered shape-based clustering for subject with and without back pain.
