...
%
%Also, statistics tools are limited 
...
%
%Mapping the distance from a group mean shape to the global mean to color allows to assess local shape
...
%
There are 127 features describing diagnosed diseases, lifestyle factors, women-specific factors, pain indicators, laboratory values and somatometric features. %and are ordered accordingly.
%
...
%While this approach does not assume any hypothesis, the 127 epidemiological features were selected by domain experts and also includes features, which are only remotly unter verdacht to be associating with back pain. %the data are met with a selection bias when compiling the list of related features by the domain experts.
%
