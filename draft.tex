...
%
We also integrate the data-driven definition of subgroups using clustering, statistically-based suggestions of potentially interesting features, and adaptive feature visualization. %tailored to epidemiological data, e.g., a mosaic plot for the frequent categorical variables.
% %
