...
The standard workflow lacks methods, which automatically identify correlations possibly buried deep in the data or overseen by the epidemiologists.
%
...
\add{%The uniqueness of the \emph{IVA} workflow applied to image-based cohort study data compared to the discussed work is threefold.
