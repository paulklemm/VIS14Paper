...
%
One is an specialist in internal medicine and also the head of the SHIP, the second an radiologist and responsible for the MRI-data acquisition of the study. \com{Years of experience} %and has a deep understanding on the available image data.
%
...
%
These outliers only of high interest for finding pathological subjects. %but not wanted when new parameters describing risk factors are established.
%
