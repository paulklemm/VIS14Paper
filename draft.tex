...
%
This is achieved by combining brushing and linking enabled coordinated information visualization views and interactive 3D-shape renderings with epidemiological data representations such as pivot tables and key figures as odds ratios.
...
%
%(Validation).
The presented concepts are applied expert-guided to gather and evaluate hypothesis about the aging process of the lumbar spine.
%
%(Results). 
...
\keywords{Interactive Visual Analysis, Epidemiology}
...
%
The sample is drawn randomized to avoid selection \cite{Fletcher2012}. %bias which prohibits statements based on statistical correlations in the cohort from being inferred to the whole population (\emph{external validity}) \cite{Fletcher2012}.
%
...
%
%As MRI scans are time-consuming and expensive there exists a tradeoff between quality of the image data and their associated costs.
%
